import { getBalanceOf } from "./lib/testUtil";
...
describe('A new job', function() {
    ...
    it('can be posted multiple times', async function() {
        ...
        await testUtil.postSampleJob(_signers.other2)(JobContract, TestToken);
        await testUtil.postSampleJob(_signers.other3)(JobContract, TestToken);
...
describe('A completable job', function() {
    ...
    it('may only be called by engineer', async function() {
        ...
        await expect(
            testUtil.completeJob(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');
    });
...
describe('An approvable job', function() {
    ...
    it('may only be called by supplier', async function() {
        ...
        await expect(
            testUtil.approveJob(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');
    });
...
describe('A closeable job', function() {
    ...
    it('may only be called by engineer or supplier', async function() {
        ...
        await expect(
            testUtil.closeJob(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');

        await expect(
            testUtil.closeJob(JobContract, testUtil.JOB_ID_1, _signers.other2)
        ).to.be.revertedWith('Method not available for this caller');
    });
...
describe('A timed-out job', function() {
    ...
    it('may only be called by engineer', async function() {
        ...
        await expect(
            testUtil.completeTimedOutJob(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');
    });
...
describe('A disputable job', function() {
    ...
    it('may only be called by supplier', async function() {
        ...
        await expect(
            testUtil.disputeJob(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');
    });
...
describe('A disputed job that will be resolved for the supplier', function() {
    ...
    it('may only be called by owner', async function() {
        ...
        await expect(
            testUtil.resolveDisputeForSupplier(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');
    });
...
describe('A disputed job that will be resolved for the engineer', function() {
    ...
    it('may only be called by owner', async function() {
        ...
        await expect(
            testUtil.resolveDisputeForEngineer(JobContract, testUtil.JOB_ID_1, _signers.other)
        ).to.be.revertedWith('Method not available for this caller');
    });
